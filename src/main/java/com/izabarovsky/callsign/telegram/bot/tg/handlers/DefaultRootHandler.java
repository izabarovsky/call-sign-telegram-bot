...
public class DefaultRootHandler implements Handler<UpdateWrapper, HandlerResult>, RootHandler<UpdateWrapper, HandlerResult> {
    ...
    public DefaultRootHandler(DialogStateService dialogService,
        ...
        repeatersAction = new RepeatersAction();
        repeatersOfficialAction = new RepeatersOfficialAction();
        repeatersNonOfficialAction = new RepeatersOfficialAction();
        repeatersEcholinkAction = new RepeatersEcholinkAction();
